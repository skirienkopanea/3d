...
<ul>
  ...
  <li>Live implementation at https://hereinmygarage.herokuapp.com (shows a random model) or to see it embedded in a blog post you can check ["3D Model Viewer" blog post](https://skirienkopanea.github.io/node/2021/01/30/3d-model-viewer.html)
</ul>
Screenshots:
